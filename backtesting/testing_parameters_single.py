...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.kama = bt.indicators.KAMAEnvelope(period=self.params.parameters[0], fast=self.params.parameters[1], slow=self.params.parameters[2], perc=self.params.parameters[3])
    ...
    def stop(self):
        self.log('(Percent %.2f) (Period %.2f) (Fast %.2f) (Slow %.2f) Ending Value %.2f' %
                 (self.params.parameters[3], self.params.parameters[0], self.params.parameters[1], self.params.parameters[2], self.broker.getvalue()), doprint=self.params.progress)
